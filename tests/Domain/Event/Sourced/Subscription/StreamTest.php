...
class StreamTest extends TestCase
{
    ...
    {
        $event2 = new SubscriptionListenedToEvent($this->event2, 1, new \DateTimeImmutable());
        $event2 = Event\Envelope::new($event2, UUID::random());
        $event4 = new SubscriptionListenedToEvent($this->event4, 100, new \DateTimeImmutable());
