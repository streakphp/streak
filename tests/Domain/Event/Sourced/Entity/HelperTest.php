...
final class EventSourcedEntityStub implements Event\Sourced\Entity
{
    ...
    private ?EventSourcedEntityStub $entity;
    private EventSourcedEntityStubId $id;
    ...
    public function __construct(EventSourcedEntityStubId $id, ?self $entity1 = null, ?self $entity2 = null)
    {
        $this->self = $this;
        $this->id = $id;
        $this->entity = $entity1;
        ...
        $this->arrayOfMixed = [-1, 0, 1, 'string 1', 'string 2', new \stdClass(), new \stdClass(), $this, $entity1, $entity2, null];
    }
