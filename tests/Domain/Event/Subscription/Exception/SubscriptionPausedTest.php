 ...
 *
 * @covers \Streak\Domain\Event\Subscription\Exception\SubscriptionPaused
 */
class SubscriptionPausedTest extends TestCase
{
    ...
    public function testException(): void
    {
        ...
        $exception = new SubscriptionPaused($this->subscription);

        self::assertSame($this->subscription, $exception->subscription());
        self::assertSame('Subscription "test_id#8c2e12ea-4cb4-4e9a-a840-a3160ca20224" is paused.', $exception->getMessage());
    }
}
