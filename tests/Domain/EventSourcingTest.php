...
use Streak\Domain\Event\Exception\NoEventApplyingMethodFound;
...
class EventSourcingTest extends TestCase
{
    public function testSuccessfullyApplyingEventOnAggregateRoot(): void
    {
        ...
        $event = new EventSourcingTest\Event0();
    ...
    public function testSuccessfullyApplyingEventOnAggregateAndAggregateRoot(): void
    {
        ...
        $event = new EventSourcingTest\Event1($aggregate1->id());
    ...
    public function testSuccessfullyApplyingEventOnAggregateButNotAggregateRoot(): void
    {
        ...
        $event = new EventSourcingTest\Event2($aggregate1->id());
    ...
    public function testSuccessfullyApplyingEventOnEntityAndAggregateAndAggregateRoot(): void
    {
        ...
        $event = new EventSourcingTest\Event1($entity1->id());
    ...
    public function testSuccessfullyApplyingEventOnEntityAndAggregateButNotAggregateRoot(): void
    {
        ...
        $event = new EventSourcingTest\Event2($entity1->id());
    ...
    public function testSuccessfullyApplyingEventOnEntityAndAggregateRootButNotAggregate(): void
    {
        ...
        $event = new EventSourcingTest\Event4($entity1->id());
    ...
    public function testNoApplyingMethodFoundOnEntity(): void
    {
        $entity1 = new EventSourcedEntityStub(new EventSourcedEntityStubId('bafbcfd1-0355-42b4-bd3f-0a5379570574'));
        $aggregate1 = new EventSourcedAggregateStub(new EventSourcedAggregateStubId('51b37ad0-9e18-47fb-89ba-8d860472c852'), $entity1);
        $aggregateRoot1 = new EventSourcedAggregateRootStub(new EventSourcedAggregateRootStubId('f5e65690-e50d-4312-a175-b004ec1bd42a'), $aggregate1);
        ...
        $event = new EventSourcingTest\Event5($entity1->id());
        $event = Event\Envelope::new($event, $aggregateRoot1->id(), 1);

        try {
            $entity1->applyEvent($event);
            self::fail();
        } catch (NoEventApplyingMethodFound $exception) {
            self::assertSame($entity1, $exception->object());
            self::assertSame($event, $exception->event());
        }
    }

    public function testNoApplyingMethodFoundOnAggregate(): void
    {
        $entity1 = new EventSourcedEntityStub(new EventSourcedEntityStubId('bafbcfd1-0355-42b4-bd3f-0a5379570574'));
        $aggregate1 = new EventSourcedAggregateStub(new EventSourcedAggregateStubId('51b37ad0-9e18-47fb-89ba-8d860472c852'), $entity1);
        $aggregateRoot1 = new EventSourcedAggregateRootStub(new EventSourcedAggregateRootStubId('f5e65690-e50d-4312-a175-b004ec1bd42a'), $aggregate1);
        ...
        $event = new EventSourcingTest\Event5($aggregate1->id());
        $event = Event\Envelope::new($event, $aggregateRoot1->id(), 1);
    ...
    public function testNoApplyingMethodFoundOnAggregateRoot1(): void
    {
        $entity1 = new EventSourcedEntityStub(new EventSourcedEntityStubId('bafbcfd1-0355-42b4-bd3f-0a5379570574'));
        $aggregate1 = new EventSourcedAggregateStub(new EventSourcedAggregateStubId('51b37ad0-9e18-47fb-89ba-8d860472c852'), $entity1);
        $aggregateRoot1 = new EventSourcedAggregateRootStub(new EventSourcedAggregateRootStubId('f5e65690-e50d-4312-a175-b004ec1bd42a'), $aggregate1);
        ...
        $event = new EventSourcingTest\Event5($aggregateRoot1->id());
        $event = Event\Envelope::new($event, $aggregateRoot1->id(), 1);
    ...
    public function testNoApplyingMethodFoundOnAggregateRoot2(): void
    {
        $entity1 = new EventSourcedEntityStub(new EventSourcedEntityStubId('bafbcfd1-0355-42b4-bd3f-0a5379570574'));
        $aggregate1 = new EventSourcedAggregateStub(new EventSourcedAggregateStubId('51b37ad0-9e18-47fb-89ba-8d860472c852'), $entity1);
        $aggregateRoot1 = new EventSourcedAggregateRootStub(new EventSourcedAggregateRootStubId('f5e65690-e50d-4312-a175-b004ec1bd42a'), $aggregate1);
        ...
        $event = new EventSourcingTest\Event5(new EventSourcedEntityStubId('be6f42d9-9a57-4e84-886d-e6cc272a1b29'));
        $event = Event\Envelope::new($event, $aggregateRoot1->id(), 1);
    ...
    public function testMismatchedEventOnAggregate1(): void
    {
        $entity1 = new EventSourcedEntityStub(new EventSourcedEntityStubId('bafbcfd1-0355-42b4-bd3f-0a5379570574'));
        $aggregate1 = new EventSourcedAggregateStub(new EventSourcedAggregateStubId('51b37ad0-9e18-47fb-89ba-8d860472c852'), $entity1);
        $aggregateRoot1 = new EventSourcedAggregateRootStub(new EventSourcedAggregateRootStubId('f5e65690-e50d-4312-a175-b004ec1bd42a'), $aggregate1);
        ...
        $event = new EventSourcingTest\Event2(new EventSourcedEntityStubId('f971941f-9101-43a0-aaab-45c7e320d839'));

        try {
            $aggregate1->commandOnAggregate($event);
            self::fail();
        } catch (EventMismatched $exception) {
            self::assertSame($aggregate1, $exception->object());
            self::assertSame($event, $exception->event()->message());
        }
    }

    public function testMismatchedEventOnAggregate2(): void
    {
        $entity1 = new EventSourcedEntityStub(new EventSourcedEntityStubId('bafbcfd1-0355-42b4-bd3f-0a5379570574'));
        $aggregate1 = new EventSourcedAggregateStub(new EventSourcedAggregateStubId('51b37ad0-9e18-47fb-89ba-8d860472c852'), $entity1);
        $aggregateRoot1 = new EventSourcedAggregateRootStub(new EventSourcedAggregateRootStubId('f5e65690-e50d-4312-a175-b004ec1bd42a'), $aggregate1);
    ...
    public function testMismatchedEventOnEntity1(): void
    {
        $entity1 = new EventSourcedEntityStub(new EventSourcedEntityStubId('bafbcfd1-0355-42b4-bd3f-0a5379570574'));
        $aggregate1 = new EventSourcedAggregateStub(new EventSourcedAggregateStubId('51b37ad0-9e18-47fb-89ba-8d860472c852'), $entity1);
        $aggregateRoot1 = new EventSourcedAggregateRootStub(new EventSourcedAggregateRootStubId('f5e65690-e50d-4312-a175-b004ec1bd42a'), $aggregate1);
    ...
    public function testMismatchedEventOnEntity2(): void
    {
        $entity1 = new EventSourcedEntityStub(new EventSourcedEntityStubId('bafbcfd1-0355-42b4-bd3f-0a5379570574'));
        $aggregate1 = new EventSourcedAggregateStub(new EventSourcedAggregateStubId('51b37ad0-9e18-47fb-89ba-8d860472c852'), $entity1);
        $aggregateRoot1 = new EventSourcedAggregateRootStub(new EventSourcedAggregateRootStubId('f5e65690-e50d-4312-a175-b004ec1bd42a'), $aggregate1);
...
class EventSourcedAggregateRootStub implements Event\Sourced\AggregateRoot
{
    ...
    public function commandOnAggregate1(Event\EntityEvent $event): void
    {
        $this->aggregate1->commandOnAggregate($event);
    }

    public function commandOnEntity1OfAggregate1(Event\EntityEvent $event): void
    {
        $this->aggregate1->commandOnEntity1($event);
    }

    public function commandOnEntity2OfAggregate1(Event\EntityEvent $event): void
    {
        $this->aggregate1->commandOnEntity2($event);
    }

    public function commandOnEntity1(Event\EntityEvent $event): void
    {
        $this->entity1->command($event);
    }

    public function commandOnAggregate2(Event\EntityEvent $event): void
    {
        $this->aggregate2->commandOnAggregate($event);
    }

    public function commandOnEntity1OfAggregate2(Event\EntityEvent $event): void
    {
        $this->aggregate2->commandOnEntity1($event);
    }

    public function commandOnEntity2OfAggregate2(Event\EntityEvent $event): void
    {
        $this->aggregate2->commandOnEntity2($event);
    }

    public function commandOnEntity2(Event\EntityEvent $event): void
    {
        $this->entity1->command($event);
    }
    ...
    private function applyEvent0(Event0 $event): void
    {
...
class EventSourcedAggregateStub implements Event\Sourced\Aggregate
{
    ...
    public function commandOnAggregate(Event\EntityEvent $event): void
    {
        $this->apply($event);
    }
...
class EventSourcedEntityStub implements Event\Sourced\Entity
{
    ...
    public function command(Event\EntityEvent $event): void
    {
        $this->apply($event);
    }
...
class Event1 implements Event\EntityEvent
{
...
class Event2 implements Event\EntityEvent
{
    public function __construct(private Entity\Id $id)
    {
    }
...
class Event3 implements Event\EntityEvent
{
    public function __construct(private Entity\Id $id)
    {
    }
...
class Event4 implements Event\EntityEvent
{
    public function __construct(private Entity\Id $id)
    {
    }
...
class Event5 implements Event\EntityEvent
{
    public function __construct(private Entity\Id $id)
    {
    }
