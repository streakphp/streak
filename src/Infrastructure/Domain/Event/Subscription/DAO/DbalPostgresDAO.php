 ...
 *
 * @see \Streak\Infrastructure\Domain\Event\Subscription\DAO\DbalPostgresDAOTest
 */
class DbalPostgresDAO implements DAO
{
    ...
    private function fromTimestamp(string $when): \DateTimeImmutable
    {
        ...
        if (false === $timestamp) {
            $timestamp = \DateTimeImmutable::createFromFormat('Y-m-d H:i:s P', $when); // @codeCoverageIgnore
        }
