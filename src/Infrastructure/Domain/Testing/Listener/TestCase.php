...
abstract class TestCase extends \PHPUnit\Framework\TestCase
{
    ...
    abstract public function createFactory(Application\CommandBus $bus): Application\Event\Listener\Factory;

    private function createScenario(Application\CommandBus $bus, Application\Event\Listener\Factory $factory): Listener\Scenario
    {
